        ...
        <div className='cards__wrapper'>
          <ul className='cards__items'>
            ...
            <InfoCardItem
              ...
              text='Aluminium Sulphate Aluminium Sulphate, Ammonium Sulphate, Calcium Hydroxide, Caustic Soda, Copper Sulphate, Ferrous Sulphate, Sulphuric Acid, Sodium Chloride (Salt), Sodium Carbonate (Soda Ash), Magnesium Oxide, Caustic Soda (Flakes, Pearls)'
              label='Our Products'
              path='/FactoryEast'
            />
          </ul>
