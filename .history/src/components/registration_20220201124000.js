...
import './../App.css'
  ...
  const Registration = React.addons.CSSTransitionGroup;
...
class App extends React.Component {
  ...
  render() {
    ...
    return <Registration transitionName="animation" transitionAppear={true} transitionAppearTimeout={500} transitionEnterTimeout={500} transitionLeaveTimeout={300}>
             { component }
           </Registration>
  }
}
