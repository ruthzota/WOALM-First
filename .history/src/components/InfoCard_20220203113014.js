        ...
        <div className='cards__wrapper'>
          <ul className='cards__items'>
            ...
            <InfoCardItem
              ...
              text='Aluminium Sulphate Kenya, East Africa", "Products":"Aluminium Sulphate, Ammonium Sulphate, Calcium Hydroxide, Caustic Soda, Copper Sulphate, Ferrous Sulphate'
              label='Our Products'
              path='/FactoryEast'
            />
          </ul>
